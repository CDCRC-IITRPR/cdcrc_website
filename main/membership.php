		...
		<div class="container">
			<div class="row" style="color: #000000;">
				<div class="col-md-8 col-sm-12">
                    <div class = "col-sm-12 col-md-12" style="text-align:center;"><h1>Membership</h1>
                    <br>
                    <div class = "row">
                        <div class="col-md-6">
                            <img src="images/members/cii.jpeg" alt="" style="width:100%; height:10vh">
                        </div>
                        <div class="col-md-6">
                            <img src="images/members/ficci.jpeg" alt="" style="width:50%; height:15vh">
                        </div>
                    </div>
                    <br>
                    <div class = "row" style="padding-left:30%;">
                        <div class="col-md-6" >
                            <img src="images/members/phd.jpeg" alt="" style="width:50%; height:15vh">
                        </div>
                    </div>
                    <br>
                    <div class = "row">
                        <div class="col-md-6">
                            <img src="images/members/bbn.jpeg" alt="" style="width:50%; height:15vh">
                        </div>
                        <div class="col-md-6">
                            <img src="images/members/sgmea.jpeg" alt="" style="width:50%; height:20vh">
                        </div>
                    </div>
                    <br>
                    <div class = "row" style="padding-left:30%;">
                        <div class="col-md-6" >
                            <img src="images/members/mia.jpeg" alt="" style="width:80%; height:15vh">
                        </div>
                    </div>
                    </div>
