...
window.onload = function () {
  document.querySelector('.sidebarMenu').addEventListener('click', el => {
    ...
    if (el.target.textContent.toString().includes("Why")) {
      let html = `
      <div class="d_message_row">
                    <p class="d_message" style="font-family: Leelawadee, sans-serif;font-size: 14.3333330154419px;">
                    ...
                    <div id="aboutiitrpr">
                        <div>
                            <p xss="removed">
                                ...
                                Ministry of
                                Human Resource Development (MHRD), Government of India, to expand the reach and enhance
                                the
                                quality of technical education in the country.


                                This Institute is committed to providing state-of-the-art technical education in a
                                variety
                                of fields and also for facilitating transmission of knowledge in keeping with latest
                                developments in pedagogy.


                                These two areas of focus will enable students to gain exposure to recent trends in their
                                chosen domains of study and gain practical experience through a wide variety of
                                activities
                                the Institute facilitates in its own campus and arranges for in collaboration with
                                industry
                            ...
                            <p xss="removed">
                                At present, the Institute offers Bachelor of Technology (B.Tech.) and B.Tech + M.Tech
                                (dual
                            ...
                            <div>
                                <div>
                                    <p xss="removed">
                                        This programme is spread over a period of four semesters. Institute offers
                                        M.Tech
                            ...
                            <div>
                                <div>
                                    ...
                                    <div>
                                        <div>
                                            <p xss="removed">
                                                Institute offers M.S(Research) programme in the following disciplines :
                                            </p>
                                            <ul>
                                                <li>
                                                    <p style="color: black;  font-size: 16px;">
                            ...
                            <div>
                                <div>
                                    ...
                                    <div>
                                        <div>
                                            <p xss="removed">
                                                In addition, the institute offers doctoral programme in following
                                                disciplines.
      ...
      <div class="d_message_row">
                    ...
                    <p xss="\">
                        ...
                        academia in India and abroad. In addition to a rigorous academic schedule, we emphasize on
                        all-round
                        development of our students. The beautiful campus, far away from the city, provides an excellent
                        environment for learning. Quick on the uptake, with good communication and interpersonal skills
                        and
                        aware of modern developments, the typical IIT rprian is expected to play a pivotal role in
                        leading
                        organizations that are competitive in terms of products, services, and technology. At IIT Ropar
                        we
                        have students meeting various requirements in diversified fields of interest and expertise of
                        the
                        industry. It would be our pleasure to welcome you to participate in the recruitment session
                        2019-2020.</p>
                    <p>
                        We have planned the following schedule at IIT Ropar for campus interviews of students graduating
                        in
                        2020 :</p>
                    <div>
                        <h5 style="color: #126aee;">
                            1. &nbsp;Pre Placement Talks [ PPT ] for Final Placements - From&nbsp; August 2019 onwards.
                        </h5>
                        <p>
                            a)&nbsp;&nbsp;If you are interested in making an early PPT – you are most welcome to book a
                            slot
                            as early as you can. This early PPT with the interactive session will give a scope for our
                            students to understand the profile of your esteemed organization, their job profile
                            including
                            job prospects etc.</p>
                        <p>
                            b)&nbsp;&nbsp; In case your company feels it inconvenient to make visit twice – you are most
                            welcome to carry out the entire selection process, including PPT, during final placement
                            season
      ...
      <div class="d_message_row">
                    ...
                    <p xss="\">
                        ...
                        academia in India and abroad. Over and above a rigorous academic schedule, we place a great
                        emphasis
                        on all-round development of our students. The beautiful campus, far away from the city, provides
                        an
                        excellent environment for learning. Each and every student is provided with an Internet
                        connection
                        in his / her hostel room. Quick on the up-take, with good communication and human relations
                        skills
                        and aware of modern developments, the typical IIT rprian is expected to play a pivotal role in
                        organizations like yours willing to be internationally competitive in terms of products,
                        services
                        and technology. At IIT Ropar you would find candidates meeting your requirements in practically
                        every field of interest to your organization. It will be my pleasure to assist in your
                        recruitment
                        efforts to meet the challenges ahead.</p>
                    <p>
                        We have planned the following schedule at IIT Ropar for campus interviews of students eligible
                        for 8
                        weeks Compulsory Internship in Summers 2019 (during 1st week of May, 2020&nbsp; to middle of
                        July,
                        2020).</p>
                    <h5 style="color: #126aee;">
                    ...
                    <p>
                        If you are interested in hiring both Interns and Full Time, you can give a combined PPT followed
                        by
                        Interns Selection the same day.</p>
                    <p>
                        If you are interested in making an early PPT - you are most welcome to block a slot + date as
                        early
                        ...
                        request you to kindly ensure your presence in the campus on the allocated slot and date for the
                        PPT
                        as otherwise we will be loosing the slot if you make any last moment change in the agreed
                        schedule.
                    </p>
                    <p>
                        In case your company feels it is inconvenient to visit twice - you are most welcome to carry out
                        the
                        entire selection process, including PPT, during final placement season on a mutually agreed
                        date.
                    </p>
                    <h5 style="color: #126aee;">
                        3. &nbsp; How to participate :</h5>
                    <p>
                        If you wish to participate in the Campus Placement and Intern selection process of 2019-20, you
                        need
    ...
    `;
      ...
      <div class="d_message_row">
                    ...
                    <p>
                        ...
                        website following which they will be issued login details. These details would enable them to
                        login
                        to the Company Portal, using which they can post job openings and see the profiles of students
                        eligible and suitable to their job specifications. You can refer to the placement
                        procedure&nbsp;<a href="http://cdc.iitrpr.ac.in/p/placement-1" target="_blank">here</a>.</p>
                    <p style="color: #126aee;">
                    ...
                    <p>
                        The Campus Placement Process for the final year student starts on&nbsp;December 1&nbsp;every
                        year.
                        The internship process starts in August.</p>
                    <p style="color: #126aee;">
                        <strong>How well is Ropar connected to the country ?</strong></p>
                    <p>
                        Ropar is well connected to all major Indian cities by rail. Alternatively, you can reach the
                        Howrah
                        railway station and then commute by train or taxi to the institute, taking an additional 2 to 3
                        hours. If you wish to travel by air, the nearest airport is NetajiSubhash Chandra Bose
                        International
                        Airport, Chandigarh. From there you can take a taxi and reach the campus in 2 ½ hours. For
                        further
                    ...
                    <p>
                        ...
                        Session is typically scheduled for 1 hour. A student coordinator will be in touch with you
                        regarding
                    ...
                    <p>
                        ...
                        completed.</p>
                    <p style="color: #126aee;">
                        <strong>Are there multiple companies recruiting in a single slot ? How is the problem of
                            multiple
                            offers resolved ?</strong></p>
                    <p>
                        Yes, there are multiple companies recruiting in each slot. The job offers of each particular
                        slot
                        are announced at the end of the slot and each candidate is required to confirm his choice by 10
                        AM
                        the next day.</p>
                    <p style="color: #126aee;">
                        <strong>Can a candidate who has already been placed sit the interviews of another company
                            ?</strong>
                    </p>
                    <p>
                    ...
                    <p style="color: #126aee;">
                        <strong>What sort of infrastructure is available on the campus for the placement process
                            ?</strong>
                    </p>
                    <p>
                        IIT Ropar is equipped with state-of-the-art communication, technological and presentation
                        facilities
